          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">
                Let's get some information to make your prof ile stand out
              </p>
              ...
              <form noValidate onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Please use comma separated values (eg. HTML,CSS,PHP,JavaScript)"
                />
                <TextFieldGroup
                  ...
                  info="If you want for latest repos and a Github link"
                />
                <TextAreaFieldGroup
